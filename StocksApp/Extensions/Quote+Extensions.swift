...
extension Quote {
    ...
    var volText: String {
        regularMarketVolume?.formatUsingAbbreviation() ?? "-"
    }
    ...
    var mktCapText: String {
        marketCap?.formatUsingAbbreviation() ?? "-"
    }
    ...
    var avgVolTezt: String {
        averageDailyVolume3Month?.formatUsingAbbreviation() ?? "-"
    }
    ...
    var columnItems: [QuoteDetailRowColumnItem] {
        [
            ...
            QuoteDetailRowColumnItem(rows: [
                ...
                QuoteDetailRowColumnItem.RowItem(title: "Avg Vol", value: avgVolTezt),
            ]),
            QuoteDetailRowColumnItem(rows: [
